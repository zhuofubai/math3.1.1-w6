...
public class FastMath_bug {
    ...
    public static Logger fastmathBug=new Logger();
    ...
    public static double cosh(double x) {
      ...
      /*************/
      double[] data4={ya,hiPrec[0],hiPrec[1]};
      expressionname="ya";
      log.add(4,data4, funname+expressionname);
      /************/
      
      double yb = -(ya - hiPrec[0] - hiPrec[1]);
      //bug3 Math.abs() store in Test3/TestCosh/Data3
      /*************/
      double[] data23={yb,ya,hiPrec[0],hiPrec[1]};
      expressionname="yb";
      log.add(23,data23, funname+expressionname);
      double[] data5={ya - hiPrec[0] - hiPrec[1],ya,hiPrec[0],hiPrec[1]};
      expressionname="ya - hiPrec[0] - hiPrec[1]";
      ...
      double yab = ya - yaa;
      /*************/
      double[] data21={yab,ya,yaa};
      expressionname="yab";
      log.add(21,data21, funname+expressionname);
      double[] data6={yaa,ya,temp};
      expressionname="yaa";
      ...
      /*************/
      double[] data7={recipa,recip,temp};
      expressionname="recipa";
      log.add(7,data7, funname+expressionname);
      double[] data22={recipb=recip,recipa};
      expressionname="recipb";
      log.add(22,data22, funname+expressionname);
      /************/
      // Correct for rounding in division
      tempexpression=recipb;
      recipb += (1.0 - yaa*recipa - yaa*recipb - yab*recipa - yab*recipb) * recip;
      //bug2 1.0 - yaa*recipa - yaa*recipb - yab*recipa - yab*recipb+1E-10 Store in Test3/TestCosh/Data2
      /*************/
      double[] data8={recipb, (1.0 - yaa*recipa - yaa*tempexpression - yab*recipa - yab*tempexpression) , recip};
      expressionname="recipb+";
      log.add(8,data8, funname+expressionname);
      
      double[] data9={(1.0 - yaa*recipa - yaa*tempexpression - yab*recipa - yab*tempexpression) , yaa*recipa , yaa*tempexpression , yab*recipa , yab*tempexpression};
      expressionname="yaa*recipa - yaa*recipb - yab*recipa - yab*recipb";
      log.add(9,data9, funname+expressionname);
      /************/
      double [] data17={yaa*recipa,yaa,recipa};
      expressionname="yaa*recipa";
      log.add(17, data17, funname+expressionname);
      
      double [] data18={yaa*tempexpression,yaa,tempexpression};
      expressionname="yaa*recipb ";
      log.add(18, data18, funname+expressionname);
      
      double [] data19={yab*recipa,yab,recipa};
      expressionname=" yab*recipa";
      log.add(19, data19, funname+expressionname);
      
      double []data20={yab*tempexpression,yab,tempexpression};
      expressionname=" yab*recip";
      log.add(20, data20, funname+expressionname);
      /***********/
      // Account for yb
      tempexpression=recipb;
      recipb += -yb * recip * recip;//bug1 +1E-10  Store in Test3/TestCosh/Data1 bug4 *5 store in Data4
      /*************/
      double[] data10={recipb,-yb * recip * recip,tempexpression};
      expressionname="recipb+2";
      log.add(10,data10, funname+expressionname);
      
      double[] data11={-yb * recip * recip,yb,recip};
      expressionname="-yb * recip * recip";
      log.add(11,data11, funname+expressionname);
      /************/
      // y = y + 1/y
      temp = ya + recipa;
      /*************/
      double[] data12={temp,recipa,ya};
      expressionname="temp";
      ...
      yb += -(temp - ya - recipa);
      /*************/
      double[] data13={yb,ya,-temp,recipa,tempexpression};
      expressionname="yb+";
      ...
      temp = ya + recipb;
      /*************/
      double[] data14={temp,recipb,ya};
      expressionname="temp2";
      log.add(14,data14, funname+expressionname);
      /************/
      tempexpression=yb;
      yb += -(temp - ya - recipb);
      /*************/
      double[] data15={yb,tempexpression,-temp,ya,recipb};
      expressionname="yb+2";
    ...
    public static double acos(double x) {
      ...
      double tempexpression=0;
      double[] data1={temp};
      String expressionname="temp";
      log.add(1,data1, funname+expressionname);
      
      final double xa = x + temp - temp;
      
      double[] data2={xa,x,temp};
      expressionname="xa";
      log.add(2,data2, funname+expressionname);
      
      final double xb = x - xa;
      double[] data3={xb,x,xa};
      expressionname="xb";
      log.add(3,data3, funname+expressionname);
      /* Square it */
      double ya = xa*xa;
      ...
      log.add(4,data4, funname+expressionname);
      double yb = xa*xb*2.0 + xb*xb;
      double[] data5={yb,xa*xb*2.0,xb*xb};
      expressionname="yb";
      log.add(5,data5, funname+expressionname);
      double[] data6={xa*xb*2,xa,xb};
      expressionname="xa*xb";
      log.add(6,data6, funname+expressionname);
      double[] data7={xb*xb,xb};
      expressionname="xb^2";
      log.add(7,data7, funname+expressionname);
      /* Subtract from 1 */
      ya = -ya;
      ...
      expressionname="za";
      log.add(8,data8, funname+expressionname);
      double[] data9={zb,za,ya};
      expressionname="zb";
      log.add(9,data9, funname+expressionname);
      
      temp = za + yb;
      double[] data10={temp,zb,za};
      expressionname="temp";
      log.add(10,data10, funname+expressionname);
      tempexpression=zb;
      zb += -(temp - za - yb);
      
      double[] data11={zb,temp,za,yb,tempexpression};
      expressionname="zb";
      log.add(11,data11, funname+expressionname);
      za = temp;
      ...
      double[] data13={temp,y};
      expressionname="temp";
      log.add(13,data13, funname+expressionname);
      
      ya = y + temp - temp;
      double[] data14={ya,y,temp};
      expressionname="ya";
      log.add(14,data14, funname+expressionname);
      yb = y - ya;
      double[] data15={yb,y,ya};
      expressionname="yb";
      log.add(15,data15, funname+expressionname);
      /* Extend precision of sqrt */
      tempexpression=yb;
      yb += (za - ya*ya - 2*ya*yb - yb*yb) / (2.0*y);
      double[] data16={yb,(za - ya*ya - 2*ya*yb - yb*yb),tempexpression,(2.0*y)};
      expressionname="yb+";
      log.add(16,data16, funname+expressionname);
      
      double[] data17={(za - ya*ya - 2*ya*yb - yb*yb),za,ya*ya,2*ya*yb,yb*yb};
      expressionname="(za - ya*ya - 2*ya*yb - yb*yb)";
      log.add(17,data17, funname+expressionname);
      /* Contribution of zb to sqrt */
      
      tempexpression=yb;
      yb += zb / (2.0*y);
      double[] data18={yb,tempexpression,zb/(2.0*y)};
      expressionname="yb+";
      log.add(18, data18, funname+expressionname);
      
      
      y = ya+yb;
      double[] data19={y,ya,yb};
      expressionname="y";
      log.add(19, data19, funname+expressionname);
      
      tempexpression=yb;
      yb = -(y - ya - yb);
      double[] data20={yb,y,ya,tempexpression};
      expressionname="yb";
      log.add(20, data20, funname+expressionname);
      // Compute ratio r = y/x
      double r = y/x;
      ...
      double[] data23={rb,r,ra};
      expressionname="rb";
      log.add(23, data23, funname+expressionname);
      tempexpression=rb;
      rb += (y - ra*xa - ra*xb - rb*xa - rb*xb) / x;  // Correct for rounding in division
      
      double[] data24={rb,(y - ra*xa - ra*xb - rb*xa - rb*xb)/x,tempexpression};
      expressionname="rb+";
      log.add(24, data24, funname+expressionname);
      
      double[] data25={(y - ra*xa - ra*xb - rb*xa - rb*xb)/x,(y - ra*xa - ra*xb - rb*xa - rb*xb),x};
      expressionname="(y - ra*xa - ra*xb - rb*xa - rb*xb)/x";
      log.add(25, data25, funname+expressionname);
      
      double[] data26={(y - ra*xa - ra*xb - rb*xa - rb*xb),y , ra*xa , ra*xb , rb*xa ,rb*xb};
      expressionname="(y - ra*xa - ra*xb - rb*xa - rb*xb)";
      log.add(26, data26, funname+expressionname);
      
      tempexpression=rb;
      rb += yb / x;  // Add in effect additional bits of sqrt.
      double[] data27={rb,rb,yb/x};
      expressionname="rb+";
      log.add(27, data27, funname+expressionname);
      
      double[] data28={yb/x,yb,x};
      expressionname="yb/x";
      log.add(28, data28, funname+expressionname);
      
      temp = ra + rb;
      double[] data29={temp,rb,ra};
      expressionname="temp";
      log.add(29, data29, funname+expressionname);
      rb = -(temp - ra - rb);
      
      double[] data30={rb,temp,ra,rb};
      expressionname="rb";
      log.add(30, data30, funname+expressionname);
      
      ra = temp;
      
      double[] data31={atan(ra, rb, x<0),ra,rb};
      expressionname="atan(ra, rb, x<0)";
      log.add(31, data31, funname+expressionname);

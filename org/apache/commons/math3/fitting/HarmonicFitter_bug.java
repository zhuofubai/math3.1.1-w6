 ...
 * @since 2.0
 */
public class HarmonicFitter_bug extends CurveFitter<HarmonicOscillator.Parametric> {
    /**
     * Simple constructor.
     * @param optimizer Optimizer to use for the fitting.
     */
    public HarmonicFitter_bug(final MultivariateVectorOptimizer optimizer) {
        super(optimizer);
    }
    ...
    public static class ParameterGuesser {
        ...
        private double[] guessAOmega(WeightedObservedPoint[] observations) {
            ...
            for (int i = 1; i < observations.length; ++i) {
                ...
                final double dx = currentX - previousX+error;//buggy1

...
import experiment.small.Short_HarmonicFitterMyTest;
 ...
 * @since 2.0
 */
public class HarmonicFitter_bug2 extends CurveFitter<HarmonicOscillator.Parametric> {
    /**
     * Simple constructor.
     * @param optimizer Optimizer to use for the fitting.
     */
    public HarmonicFitter_bug2(final MultivariateVectorOptimizer optimizer) {
        super(optimizer);
    }
    ...
    public static class ParameterGuesser {
        ...
        private double[] guessAOmega(WeightedObservedPoint[] observations) {
            ...
            for (int i = 1; i < observations.length; ++i) {
                ...
                final double dx = currentX - previousX;//buggy1+error
        ...
        private double guessPhi(WeightedObservedPoint[] observations) {
            ...
            double fcMean = 0;
            double fsMean = 0;
            double error=Short_HarmonicFitterMyTest.createSmallNumber();
            double currentX = observations[0].getX();
            double currentY = observations[0].getY();
            for (int i = 1; i < observations.length; ++i) {
                // one step forward
                ...
                fsMean =fsMean*(1+error)+ omega * currentY * sine + currentYPrime * cosine;//buggy2 fsmean*(1+error)
         //       System.out.print("a");
            }

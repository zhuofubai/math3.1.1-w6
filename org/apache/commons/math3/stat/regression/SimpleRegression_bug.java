 ...
 */
public class SimpleRegression_bug implements Serializable, UpdatingMultipleLinearRegression {
    ...
    */
    public SimpleRegression_bug(boolean includeIntercept) {
        super();
     ...
     * @see #SimpleRegression_bug(boolean)
     */

 ...
 * @since 3.0
 */
public class MillerUpdatingRegression_bug1 implements UpdatingMultipleLinearRegression {
    ...
    private MillerUpdatingRegression_bug1() {
     ...
     */
    public MillerUpdatingRegression_bug1(int numberOfVariables, boolean includeConstant, double errorTolerance)
     ...
     * @throws ModelSpecificationException if {@code numberOfVariables is less than 1}
     */
    public MillerUpdatingRegression_bug1(int numberOfVariables, boolean includeConstant)
    throws ModelSpecificationException {

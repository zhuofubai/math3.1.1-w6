...
import experiment.small.Short_GTestMyTest;
 ...
 *
 * @version $Id: GTest.java 1416643 2012-12-03 19:37:14Z tn $
 * @since 3.1
 */
public class GTest_bug1 {
    ...
    public double g(final double[] expected, final long[] observed)
        ...
        return 2d * sum+Short_GTestMyTest.createSmallNumber();//buggy1
    }

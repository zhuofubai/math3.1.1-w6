...
/**
 *bug 1 at line 1657, bug2 at line 521
 * @deprecated As of 3.1 (to be removed in 4.0).
 * @since 3.0
 */
@Deprecated
public class BOBYQAOptimizer_bug
     ...
     */
    public BOBYQAOptimizer_bug(int numberOfInterpolationPoints) {
        ...
        case 60: {
            ...
            if (dnorm < HALF * rho) {
                ...
                for (int j = 0; j < n; j++) {
                    ...
                    if (bdtest < bdtol) {
                    	/********bug2 modelSecondDerivativesValues.getEntry((j + j * j) / 2)************************/
                        System.out.println("bug2 happen");
                    	double curv = modelSecondDerivativesValues.getEntry((j + j * j) / 2-1);
                        for (int k = 0; k < npt; k++) {
                            // Computing 2nd power
    ...
    private double[] altmov(
        ...
        while (true) {
            ...
            for (int k = 0; k < npt; k++) {
                ...
                //bug4
                curv += hcol.getEntry(k) * tmp * tmp;//tmp*tmp
            }
            if (iflag == 1) {
                curv = -curv;
            }
...
//                 throw new PathIsExploredException(); // XXX
    ...
    private static class PathIsExploredException extends RuntimeException {
        ...
        PathIsExploredException() {
            super(PATH_IS_EXPLORED + " " + BOBYQAOptimizer_bug.caller(3));
        }
    }
}

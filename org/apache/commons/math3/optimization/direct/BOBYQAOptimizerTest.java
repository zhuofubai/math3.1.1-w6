...
public class BOBYQAOptimizerTest {
    ...
    public void testMaximize() {
        ...
        double[] startPoint = point(DIM,1.9);
        double[][] boundaries = null;
        ...
        doTest(new MinusElli(), startPoint, boundaries,
                GoalType.MAXIMIZE, 
                2e-10, 5e-6, 1000, 2, expected,"num=" + 2);
    }
    ...
    public void testEllipse() {
        ...
        doTest(new Elli(), startPoint, boundaries,
                GoalType.MINIMIZE, 
                1e-13, 1e-6, 1000,2, expected,"num=" + 2);
     }
    ...
    public void testElliRotated() {
        ...
        doTest(new ElliRotated(), startPoint, boundaries,
                GoalType.MINIMIZE, 
                1e-12, 1e-6, 10000, 2,expected,"num=" + 2);
    }
    ...
    public void testCigar() {
        ...
        doTest(new Cigar(), startPoint, boundaries,
                GoalType.MINIMIZE, 
                1e-13, 1e-6, 100, 2,expected,"num=" + 2);
    }
    ...
    public void testCigTab() {
        ...
        doTest(new CigTab(), startPoint, boundaries,
                GoalType.MINIMIZE, 
                1e-13, 5e-5, 100, 2, expected,"num=" + 2);
     }

    @Test
    public void testSphere() {
    	System.out.println("test12");
        double[] startPoint = point(DIM,0.6);
        double[][] boundaries = null;
        PointValuePair expected =
            new PointValuePair(point(DIM,0.0),0.0);
    ...
    public void testDiffPow() {
        ...
        doTest(new DiffPow(), startPoint, boundaries,
                GoalType.MAXIMIZE, 
                1e-8, 1e-1, 12000, 2,expected,"num=" + 2);
    }

    @Test
    public void testSsDiffPow() {
    	System.out.println("test15");
        double[] startPoint = point(DIM/2,0.1);
        double[][] boundaries = null;
        PointValuePair expected =
            new PointValuePair(point(DIM/2,0.0),0.0);
        doTest(new SsDiffPow(), startPoint, boundaries,
                GoalType.MINIMIZE, 
                1e-2, 1.3e-1, 50000, 2, expected,"num=" + 2);
    }
    ...
    public void testAckley() {
        ...
        doTest(new Ackley(), startPoint, boundaries,
                GoalType.MINIMIZE,
                1e-8, 1e-5, 1000, 2,expected,"num=" + 2);
    }
    ...
    public void testConstrainedRosen() {
        ...
        doTest(new Rosen(), startPoint, boundaries,
                GoalType.MINIMIZE,
                1e-13, 1e-6, 2000,2, expected,"num=" + 2);
    }
    ...
    public void testConstrainedRosenWithMoreInterpolationPoints() {
        ...
        // 65, 66, ...
        final int maxAdditionalPoints = 2;

 ...
 * <p>{@link DerivativeStructure_bug} instances can be used directly thanks to
 ...
 * DerivativeStructure_bug}-based instances. This method is simpler but may be limited in
 ...
 * @since 3.1
 */
public class DerivativeStructure_bug implements FieldElement<DerivativeStructure_bug>, Serializable {

    /** Serializable UID. */
    private static final long serialVersionUID = 20120730L;

    /** Compiler for the current dimensions. */
    private transient DSCompiler_bug11 compiler;
     ...
     */
    private DerivativeStructure_bug(final DSCompiler_bug11 compiler) {
     ...
     */
    public DerivativeStructure_bug(final int parameters, final int order) {
        this(DSCompiler_bug11.getCompiler(parameters, order));
    }
     ...
     * @see #DerivativeStructure_bug(int, int, int, double)
     */
    public DerivativeStructure_bug(final int parameters, final int order, final double value) {
     ...
     * @see #DerivativeStructure_bug(int, int, double)
     */
    public DerivativeStructure_bug(final int parameters, final int order,
     ...
     */
    public DerivativeStructure_bug(final double a1, final DerivativeStructure_bug ds1,
                               final double a2, final DerivativeStructure_bug ds2)
    ...
    public DerivativeStructure_bug(final double a1, final DerivativeStructure_bug ds1,
                               final double a2, final DerivativeStructure_bug ds2,
                               final double a3, final DerivativeStructure_bug ds3)
        throws DimensionMismatchException {
        this(ds1.compiler);
        compiler.checkCompatibility(ds2.compiler);
    ...
    public DerivativeStructure_bug(final double a1, final DerivativeStructure_bug ds1,
                               final double a2, final DerivativeStructure_bug ds2,
                               final double a3, final DerivativeStructure_bug ds3,
                               final double a4, final DerivativeStructure_bug ds4)
        throws DimensionMismatchException {
        this(ds1.compiler);
        compiler.checkCompatibility(ds2.compiler);
        compiler.checkCompatibility(ds3.compiler);
     ...
     */
    public DerivativeStructure_bug(final int parameters, final int order, final double ... derivatives)
        throws DimensionMismatchException {
        this(parameters, order);
     ...
     */
    private DerivativeStructure_bug(final DerivativeStructure_bug ds) {
     ...
     * @return this+a
     */
    public DerivativeStructure_bug add(final double a) {
        final DerivativeStructure_bug ds = new DerivativeStructure_bug(this);
        ds.data[0] += a;
        return ds;
    }
     ...
     * @exception DimensionMismatchException if number of free parameters or orders are inconsistent
     */
    public DerivativeStructure_bug add(final DerivativeStructure_bug a)
        throws DimensionMismatchException {
     ...
     * @return this-a
     */
    public DerivativeStructure_bug subtract(final double a) {
        return add(-a);
    }
     ...
     * @exception DimensionMismatchException if number of free parameters or orders are inconsistent
     */
    public DerivativeStructure_bug subtract(final DerivativeStructure_bug a)
        throws DimensionMismatchException {
        compiler.checkCompatibility(a.compiler);
        final DerivativeStructure_bug ds = new DerivativeStructure_bug(this);
    ...
    /** {@inheritDoc} */
    public DerivativeStructure_bug multiply(final int n) {
     ...
     * @return this&times;a
     */
    public DerivativeStructure_bug multiply(final double a) {
        final DerivativeStructure_bug ds = new DerivativeStructure_bug(this);
     ...
     * @exception DimensionMismatchException if number of free parameters or orders are inconsistent
     */
    public DerivativeStructure_bug multiply(final DerivativeStructure_bug a)
        throws DimensionMismatchException {
        compiler.checkCompatibility(a.compiler);
        final DerivativeStructure_bug result = new DerivativeStructure_bug(compiler);
     ...
     */
    public DerivativeStructure_bug divide(final double a) {
        final DerivativeStructure_bug ds = new DerivativeStructure_bug(this);
        for (int i = 0; i < ds.data.length; ++i) {
            ds.data[i] /= a;
        }
     ...
     * @exception DimensionMismatchException if number of free parameters or orders are inconsistent
     */
    public DerivativeStructure_bug divide(final DerivativeStructure_bug a)
        throws DimensionMismatchException {
        compiler.checkCompatibility(a.compiler);
        final DerivativeStructure_bug result = new DerivativeStructure_bug(compiler);
     ...
     * @return this%a
     */
    public DerivativeStructure_bug remainder(final double a) {
        final DerivativeStructure_bug ds = new DerivativeStructure_bug(this);
     ...
     * @exception DimensionMismatchException if number of free parameters or orders are inconsistent
     */
    public DerivativeStructure_bug remainder(final DerivativeStructure_bug a)
        throws DimensionMismatchException {
        compiler.checkCompatibility(a.compiler);
        final DerivativeStructure_bug result = new DerivativeStructure_bug(compiler);
     ...
     * @return -this
     */
    public DerivativeStructure_bug negate() {
        final DerivativeStructure_bug ds = new DerivativeStructure_bug(compiler);
        for (int i = 0; i < ds.data.length; ++i) {
            ds.data[i] = -data[i];
        }
        return ds;
     ...
     * @return abs(this)
     */
    public DerivativeStructure_bug abs() {
     ...
     * @return ceil(this)
     */
    public DerivativeStructure_bug ceil() {
        return new DerivativeStructure_bug(compiler.getFreeParameters(),
                                       compiler.getOrder(),
     ...
     * @return floor(this)
     */
    public DerivativeStructure_bug floor() {
        return new DerivativeStructure_bug(compiler.getFreeParameters(),
                                       compiler.getOrder(),
     ...
     */
    public DerivativeStructure_bug rint() {
        return new DerivativeStructure_bug(compiler.getFreeParameters(),
                                       compiler.getOrder(),
     ...
     */
    public DerivativeStructure_bug signum() {
        return new DerivativeStructure_bug(compiler.getFreeParameters(),
                                       compiler.getOrder(),
     ...
     */
    public DerivativeStructure_bug copySign(final double sign){
     ...
     */
    public DerivativeStructure_bug scalb(final int n) {
        final DerivativeStructure_bug ds = new DerivativeStructure_bug(compiler);
        for (int i = 0; i < ds.data.length; ++i) {
     ...
     * @exception DimensionMismatchException if number of free parameters or orders are inconsistent
     */
    public static DerivativeStructure_bug hypot(final DerivativeStructure_bug x, final DerivativeStructure_bug y)
        throws DimensionMismatchException {

        x.compiler.checkCompatibility(y.compiler);

        if (Double.isInfinite(x.data[0]) || Double.isInfinite(y.data[0])) {
            return new DerivativeStructure_bug(x.compiler.getFreeParameters(),
            ...
            if (expX > expY + 27) {
                ...
                final DerivativeStructure_bug scaledX = x.scalb(-middleExp);
                final DerivativeStructure_bug scaledY = y.scalb(-middleExp);

                // compute scaled hypotenuse
                final DerivativeStructure_bug scaledH =
     ...
     */
    public DerivativeStructure_bug compose(final double ... f) {
    ...
    /** {@inheritDoc} */
    public DerivativeStructure_bug reciprocal() {
        final DerivativeStructure_bug result = new DerivativeStructure_bug(compiler);
     ...
     */
    public DerivativeStructure_bug sqrt() {
        return rootN(2);
    }
     ...
     */
    public DerivativeStructure_bug cbrt() {
        return rootN(3);
    }
     ...
     */
    public DerivativeStructure_bug rootN(final int n) {
        final DerivativeStructure_bug result = new DerivativeStructure_bug(compiler);
    ...
    /** {@inheritDoc} */
    public Field<DerivativeStructure_bug> getField() {
        return new Field<DerivativeStructure_bug>() {

            /** {@inheritDoc} */
            public DerivativeStructure_bug getZero() {
                return new DerivativeStructure_bug(compiler.getFreeParameters(), compiler.getOrder(), 0.0);
            }

            /** {@inheritDoc} */
            public DerivativeStructure_bug getOne() {
                return new DerivativeStructure_bug(compiler.getFreeParameters(), compiler.getOrder(), 1.0);
            }

            /** {@inheritDoc} */
            public Class<? extends FieldElement<DerivativeStructure_bug>> getRuntimeClass() {
                return DerivativeStructure_bug.class;
            }
     ...
     */
    public DerivativeStructure_bug pow(final double p) {
        final DerivativeStructure_bug result = new DerivativeStructure_bug(compiler);
     ...
     */
    public DerivativeStructure_bug pow(final int n) {
        final DerivativeStructure_bug result = new DerivativeStructure_bug(compiler);
     ...
     * @exception DimensionMismatchException if number of free parameters or orders are inconsistent
     */
    public DerivativeStructure_bug pow(final DerivativeStructure_bug e)
        throws DimensionMismatchException {
     ...
     */
    public DerivativeStructure_bug exp() {
        final DerivativeStructure_bug result = new DerivativeStructure_bug(compiler);
     ...
     */
    public DerivativeStructure_bug expm1() {
        final DerivativeStructure_bug result = new DerivativeStructure_bug(compiler);
     ...
     */
    public DerivativeStructure_bug log() {
        final DerivativeStructure_bug result = new DerivativeStructure_bug(compiler);
     ...
     */
    public DerivativeStructure_bug log1p() {
        final DerivativeStructure_bug result = new DerivativeStructure_bug(compiler);
     ...
     */
    public DerivativeStructure_bug log10() {
        final DerivativeStructure_bug result = new DerivativeStructure_bug(compiler);
     ...
     * @return cos(this)
     */
    public DerivativeStructure_bug cos() {
        final DerivativeStructure_bug result = new DerivativeStructure_bug(compiler);
     ...
     * @return sin(this)
     */
    public DerivativeStructure_bug sin() {
        final DerivativeStructure_bug result = new DerivativeStructure_bug(compiler);
     ...
     * @return tan(this)
     */
    public DerivativeStructure_bug tan() {
        final DerivativeStructure_bug result = new DerivativeStructure_bug(compiler);
     ...
     * @return acos(this)
     */
    public DerivativeStructure_bug acos() {
        final DerivativeStructure_bug result = new DerivativeStructure_bug(compiler);
     ...
     * @return asin(this)
     */
    public DerivativeStructure_bug asin() {
        final DerivativeStructure_bug result = new DerivativeStructure_bug(compiler);
     ...
     * @return atan(this)
     */
    public DerivativeStructure_bug atan() {
        final DerivativeStructure_bug result = new DerivativeStructure_bug(compiler);
     ...
     * @exception DimensionMismatchException if number of free parameters or orders are inconsistent
     */
    public static DerivativeStructure_bug atan2(final DerivativeStructure_bug y, final DerivativeStructure_bug x)
        throws DimensionMismatchException {
        y.compiler.checkCompatibility(x.compiler);
        final DerivativeStructure_bug result = new DerivativeStructure_bug(y.compiler);
     ...
     * @return cosh(this)
     */
    public DerivativeStructure_bug cosh() {
        final DerivativeStructure_bug result = new DerivativeStructure_bug(compiler);
     ...
     * @return sinh(this)
     */
    public DerivativeStructure_bug sinh() {
        final DerivativeStructure_bug result = new DerivativeStructure_bug(compiler);
     ...
     * @return tanh(this)
     */
    public DerivativeStructure_bug tanh() {
        final DerivativeStructure_bug result = new DerivativeStructure_bug(compiler);
     ...
     * @return acosh(this)
     */
    public DerivativeStructure_bug acosh() {
        final DerivativeStructure_bug result = new DerivativeStructure_bug(compiler);
     ...
     * @return asin(this)
     */
    public DerivativeStructure_bug asinh() {
        final DerivativeStructure_bug result = new DerivativeStructure_bug(compiler);
     ...
     * @return atanh(this)
     */
    public DerivativeStructure_bug atanh() {
        final DerivativeStructure_bug result = new DerivativeStructure_bug(compiler);
     ...
     */
    public DerivativeStructure_bug toDegrees() {
        final DerivativeStructure_bug ds = new DerivativeStructure_bug(compiler);
        for (int i = 0; i < ds.data.length; ++i) {
     ...
     */
    public DerivativeStructure_bug toRadians() {
        final DerivativeStructure_bug ds = new DerivativeStructure_bug(compiler);
        for (int i = 0; i < ds.data.length; ++i) {
    ...
    private static class DataTransferObject implements Serializable {
        ...
        /** Replace the deserialized data transfer object with a {@link DerivativeStructure_bug}.
         * @return replacement {@link DerivativeStructure_bug}
         */
        private Object readResolve() {
            return new DerivativeStructure_bug(variables, order, data);
        }

    }
    	public DSCompiler_bug11 getCompiler(){
    		return compiler;
    	}
}

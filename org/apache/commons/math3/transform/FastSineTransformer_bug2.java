...
import experiment.small.Short_TestFastSine;
 ...
 * @since 1.2
 */
public class FastSineTransformer_bug2 implements RealTransformer, Serializable {
     ...
     */
    public FastSineTransformer_bug2(final DstNormalization normalization) {
    ...
    protected double[] fst(double[] f) throws MathIllegalArgumentException {
        ...
        x[0] = 0.0;
        x[n >> 1] = 2.0 * f[n >> 1];//+Short_TestFastSine.createSmallNumber();//buggy1;
        ...
        transformed[0] = 0.0;
        transformed[1] = 0.5 * y[0].getReal()*(1+Short_TestFastSine.createSmallNumber());//buggy2
